  ...
  preload() {
    ...
    requestData({
      ...
      if (res.data.success) {
        ...
        var str=''
        for(let i=0;i<window.totalPage*3;i++){
            str+="<audio class='audio' preload='auto'></audio>"
        }
    ...
    game.load.image('bgImg', 'assets/paopaoNoshadow/images/bg.jpg');
    game.load.image('paopao', 'assets/paopaoNoshadow/images/paopao.png')

    game.load.audio('pp', 'assets/paopaoNoshadow/audio/pp.mp3');
    game.load.audio('Cpp', 'assets/paopaoNoshadow/audio/Cpp.mp3');
    game.load.audio('wrong', 'assets/paopaoNoshadow/audio/wrong.mp3');
    game.load.audio('bubble', 'assets/paopaoNoshadow/audio/bubble.mp3');
